...
DOC_TYPE_RULES = [
    ("conference", r"conference|symposium|proceedings|workshop|研讨会|会议|论坛"),
    ("thesis", r"thesis|dissertation|学位论文|博士论文|硕士论文"),
    ("report", r"report|white paper|年度报告|报告"),
    ("book", r"monograph|手册|manual|book|教材|专著"),
]
CATEGORY_KEYWORDS = {
    "ai": [
...
def parse_files(file_path: str, file_type: str) -> Dict[str, str]:
    ...
    normalized["parsed_at"] = datetime.now().strftime("%Y-%m-%d %H:%M:%S")
