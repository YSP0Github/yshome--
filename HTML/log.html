...
<body>
    <div class="shell">
        <div class="container a-container" id="a-container">
            <form action="postReg.php" method="post" class="form" id="a-form">
                ...
                <input name="uername" type="text" class="form_input" placeholder="Name">
        ...
        <div class="container b-container" id="b-container">
            <form action="" method="" class="form" id="b-form">
                ...
                <button class="form_button button submit "><a href="index.html" > SIGN IN</a></button>
            </form>
        </div>
        ...
        <div class="switch" id="switch-cnt">
            ...
            <div class="switch_container" id="switch-c1">
                ...
                <p class="switch_description description">已经有账号了嘛，去登入账号来进入云凇之家吧！！！</p>
